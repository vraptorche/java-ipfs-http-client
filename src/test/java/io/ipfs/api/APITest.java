...
public class APITest {
	...
	public void ipldNode() {
		Function<Stream<Pair<String, CborObject>>, CborObject.CborMap> map =
				s -> CborObject.CborMap.build(s.collect(Collectors.toMap(Pair::left, Pair::right)));
...
//            List<Multihash> rm2 = ipfs.pin.rm(hash);
 ...
 //            byte[] data = "some random textual data".getBytes();
	...
	public void publish() throws Exception {
		...
		assertEquals("expected to be zdpuAknRh1Kro2r2xBDKiXyTiwA3Nu5XcmvjRPA1VNjH41NF7", "zdpuAknRh1Kro2r2xBDKiXyTiwA3Nu5XcmvjRPA1VNjH41NF7", merkleNode.hash.toString());
		...
		assertEquals("Should be equals", resolved, "/ipfs/" + merkleNode.hash.toString());
	}
